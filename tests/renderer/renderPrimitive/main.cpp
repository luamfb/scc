...
void gameLoop()
{
	...
	while(!quit) {
		...
		window.renderer->drawPoints(std::vector<SDL_Point>{
		...
		window.renderer->drawLines(std::vector<SDL_Point>{
		...
		window.renderer->drawRects(std::vector<SDL_Rect>{
			{650, 200, 100, 50},
			{700, 250, 100, 50},
			{650, 300, 100, 50},
			{700, 350, 100, 50}
		...
		window.renderer->fillRects(std::vector<SDL_Rect>{
			{600, 200, 50, 50},
			{750, 200, 50, 50},
			{600, 250, 100, 50},
			{600, 300, 50, 50},
